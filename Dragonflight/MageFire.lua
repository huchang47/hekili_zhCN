...
spec:RegisterSetting( "prevent_hardcasts", false, {
    ...
    desc = strformat( "如果勾选，在你移动时，不建议使用非瞬发的 %s 和 %s。\n\n"
        .. "如果 %s 有天赋支撑，并且是你的施法会在 |W%s|w 过期前完成，那就可能推荐非瞬发的该技能。", Hekili:GetSpellLinkWithTexture( spec.abilities.pyroblast.id ), Hekili:GetSpellLinkWithTexture( spec.abilities.fireball.id ),
