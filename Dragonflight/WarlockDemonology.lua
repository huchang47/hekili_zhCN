...
spec:RegisterSetting( "tyrant_padding", 1, {
    type = "range",
    name = strformat( "%s 缓冲", Hekili:GetSpellLinkWithTexture( spec.abilities.summon_demonic_tyrant.id ) ),
    desc = strformat( "此值确定会提前多少个全局冷却时间（GCD）建议使用%s，以避免使你的恶魔在施法完成之前就过期的风险。\n\n"
        .. "默认的 SimulationCraft 值为 |cFFFFD1001|r GCD；此选项允许将其总共延长到 2.5 个 GCD。",
