...
spec:RegisterSetting( "priority_rotation", false, {
    name = "使用优先级轮换（归集伤害）",
    desc = "如果勾选，默认的优先级将会推荐使用|T1375677:0|t袖剑风暴建立连击点，然后花费在单目标终结技上。",
    type = "toggle",
    width = "full"
})
