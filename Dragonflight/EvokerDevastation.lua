...
spec:RegisterSetting( "dragonrage_pad", 0.5, {
    ...
    desc = strformat( "如果设置大于0，则会分配额外的时间，以确保在 %s 持续时使用 %s 和 %s，减少无法延长它的风险。"
        .. "\n\n如果 %s 没有天赋支撑，这个选项会被忽略。", Hekili:GetSpellLinkWithTexture( spec.abilities.dragonrage.id ),Hekili:GetSpellLinkWithTexture( spec.abilities.fire_breath.id ),
        Hekili:GetSpellLinkWithTexture( spec.abilities.eternity_surge.id ), 
