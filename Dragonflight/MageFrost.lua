...
--[[ spec:RegisterSetting( "manual_water_jet", false, {
    name = strformat( "%s: 手动控制", Hekili:GetSpellLinkWithTexture( spec.abilities.water_jet.id ) ),
    desc = strformat( "如果勾选，可能会推荐你手动施放宠物的 %s 技能，而不是让它自动施放。 "
        .. "当你的宠物通过 %s 召唤时，该技能可用。\n\n"
        .. "在使用该功能之前，你需要关闭技能的自动施放。", Hekili:GetSpellLinkWithTexture( spec.abilities.water_jet.id ),
