...
spec:RegisterSetting( "ambush_anyway", false, {
    name = "无视天赋|T132282:0|t使用伏击",
    desc = "如果勾选，插件将会推荐使用|T132282:0|t伏击，无论是否拥有藏锋寻时和洞悉弱点天赋。\n\n" ..
        "巨龙时代的Simc模拟只会在拥有这两个天赋时才使用伏击，这可能不是最佳方案。",
    type = "toggle",
    width = "full",
} )

spec:RegisterSetting( "no_rtb_in_dance_cto", true, {
    name = "绝不在|T1373910:0|t命运骨骰持续时使用|T236279:0|t暗影之舞",
    desc = function()
        return "如果勾选，|T1373910:0|t 命运骨骰期间，|T236279:0|t暗影之舞不会被推荐。"
            .. "这与教学一致，但截至2023年2月12日，还没有反映在默认的Simc配置文件中。\n\n"
            .. ( state.talent.count_the_odds.enabled and "|cFF00FF00" or "|cFFFF0000" ) .. "需要|T237284:0|t潜伏胜机|r"
    end,
    type = "toggle",
    width = "full"
} )
...
spec:RegisterSetting( "use_ld_opener", false, {
    name = "|T136206:0|t冲动之前使用|T1373910:0|t命运骨骰（起手）",
    desc = function()
        return "如果勾选，插件将在起手时推荐在|T136206:0|t冲动之前使用|T1373910:0|t命运骨骰， Roll the Bones during the opener to guarantee "
            .. "以保证至少有2个来自|T236279:0|t灌铅骰子的Buff。\n\n"
            .. ( state.talent.loaded_dice.enabled and "|cFF00FF00" or "|cFFFF0000" ) .. "需要|T236279:0|t灌铅骰子|r"
    end,
    type = "toggle",
    width = "full"
} )
...
spec:RegisterSetting( "allow_shadowmeld", false, {
    name = "使用|T132089:0|t影遁",
    desc = "如果勾选，当条件满足时，插件将会推荐你使用暗夜精灵的|T132089:0|t影遁。你依赖隐身的技能可以在影遁中使用，即使你的动作条没有切换为隐身时的技能。" ..
        "只有在BOSS战或组队时才会推荐使用影遁（避免脱离战斗）。",
    type = "toggle",
    width = "full",
