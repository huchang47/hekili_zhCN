...
spec:RegisterSetting( "priority_rotation", false, {
    name = "归集AOE -> 主目标",
    desc = "如果勾选，插件的默认优先级将在多目标战斗时，把伤害集中于你的主目标。",
    type = "toggle",
    width = 1.5
} )
