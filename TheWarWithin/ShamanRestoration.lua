...
spec:RegisterSetting( "second_shield", "earth_shield", {
    ...
    desc = strformat( "当拥有 %s 天赋时，使用 %s 后使用哪个 %s 技能。", Hekili:GetSpellLinkWithTexture( spec.talents.elemental_orbit[2] ),Hekili:GetSpellLinkWithTexture( spec.abilities.water_shield.id ),_G.SHIELDSLOT),
    type = "select",
    values = function()
        return {
