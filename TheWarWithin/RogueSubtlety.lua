...
spec:RegisterSetting( "mfd_points", 3, {
    ...
    desc = "插件只会在你拥有指定数量或更少的连击点数时推荐使用 |T236364:0|t 死亡标记。",
    type = "range",
    min = 0,
    max = 5,
    step = 1,
...
spec:RegisterSetting( "solo_vanish", true, {
    name = "允许单人战斗时使用|T132331:0|t消失",
    desc = "如果不勾选，插件将不会推荐你在单人战斗时使用|T132331:0|t消失（避免脱离战斗）。",
    type = "toggle",
    width = "full"
} )
