...
spec:RegisterSetting( "dynamic_strike_of_the_windlord", false, {
    name = strformat( "%s:团本爆发", Hekili:GetSpellLinkWithTexture( spec.abilities.strike_of_the_windlord.id ) ),
    desc = strformat(
...
spec:RegisterSetting( "tok_damage", 1, {
    ...
    desc = strformat( "如果设置大于0，只有当你在过去 3 秒内所受的伤害达到你最大生命值的该百分比时，才会推荐使用%s。",
