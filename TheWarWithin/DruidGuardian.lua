...
--[[ spec:RegisterSetting( "shift_for_convoke", false, {
    name = "使用|T3636839:0|t万灵之召前切换形态",
    desc = "如果勾选，插件将推荐你在使用|T3636839:0|t万灵之召之前切换到野性/平衡形态。\n\n" ..
