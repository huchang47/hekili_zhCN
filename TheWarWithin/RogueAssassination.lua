...
spec:RegisterSetting( "envenom_pool_pct", 50, {
    name = "|T132287:0|t毒伤能量阈值",
    desc = "如果设置为大于0，插件将在能量达到该数值之后才推荐使用|T132287:0|t毒伤。",
    type = "range",
    min = 0,
    max = 100,
    step = 1,
