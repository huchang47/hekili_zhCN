...
spec:RegisterSetting( "envenom_pool_pct", 0, {
    name = "使用 |T132287:0|t 毒伤的能量百分比",
    desc = "如果设置大于0，|T132287:0|t 毒伤将只会在你拥有至少这个百分比的能量时被使用。",
    type = "range",
    min = 0,
    max = 100,
    step = 1,
