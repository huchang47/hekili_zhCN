...
spec:RegisterSetting( "barbed_shot_grace_period", 1, {
    name = strformat( "%s 宽限期", Hekili:GetSpellLinkWithTexture( spec.abilities.barbed_shot.id ) ),
