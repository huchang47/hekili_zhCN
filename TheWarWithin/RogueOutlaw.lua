...
spec:RegisterSetting( "never_roll_in_window", false, {
    ...
    desc = strformat( "如果勾选，则在 %s 或 %s 处于激活状态时，不会推荐使用 %s。\n\n"
