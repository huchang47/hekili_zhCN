...
spec:RegisterSetting( "t30_bloodthirst_crit", 95, {
    ...
    desc = strformat( "默认情况下，如果你装备了四件T30套装，当爆击阈值几率为|cFFFFD10095%%|r或更高时，将会推荐|W%s|w 和 |W%s|w。\n\n"
            .. "你的套装效果、%s 和 %s 都可以超过95%%的阈值。如果有|W%s|w 的天赋支撑，还会产生 %s 的额外伤害。"
