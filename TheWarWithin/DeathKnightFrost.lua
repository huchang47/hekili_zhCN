...
spec:RegisterSetting( "dnd_while_moving", true, {
    ...
    desc = strformat( "如果勾选，则在玩家移动时也会推荐 %s，否则仅在站定时推荐。", Hekili:GetSpellLinkWithTexture( spec.abilities.death_and_decay.id ) ),
    type = "toggle",
    width = "full",
} )
