            ...
            if not specsParsed then
                ...
                for i, spec in pairs( Hekili.Class.specs ) do
                    if i > 0 then
                        ...
                        insert( menuData, {
                            text = "|TInterface\\Addons\\Hekili\\Textures\\Cycle:0|t 推荐目标切换",
                            tooltipTitle = "|TInterface\\Addons\\Hekili\\Textures\\Cycle:0|t 推荐目标切换",
                                ...
                                if setting.info.type == "toggle" then
                                    ...
                                    insert( menuData, {
                                        ...
                                        func = function ()
                                            ...
                                            if Hekili.DB.profile.notifications.enabled then
                                                Hekili:Notify( name .. ": " .. ( setting.info.get( menu.args ) and "开" or "关" ) )
                                            else
                                                Hekili:Print( name .. ": " .. ( setting.info.get( menu.args ) and " |cFF00FF00启用|r." or " |cFFFF0000禁用|r." ) )
                                            end
                                        end,
                                        checked = function ()
                                            menu.args[1] = setting.name
